...
import DrivingLicenseComponent from '@/views/apps/caregiver/add-employee/DrivingLicenseComponent'
import PageNavigationButtons from '@layouts/components/horizontal/PageNavigationButtons'
import TrainingCertificatesComponent from '@/views/apps/caregiver/add-employee/TrainingCertificatesComponent'
