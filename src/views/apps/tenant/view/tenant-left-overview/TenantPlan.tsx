            ...
            <Card className='border-2 border-[#4B0082] shadow-primarySm'>
                <CardContent className='flex flex-col gap-6'>
                    <div className='flex justify-between'>
                        <Chip label='standard' size='small' color='primary' variant='tonal' sx={{
                            "& .MuiChip-label": {
                                color: "#4B0082", // Set text color
                            },
                        }} />
                        <div className='flex justify-center'>
                            <Typography component='sup' variant='h5' className='self-start mbs-2' color='primary.main' sx={{ color: "#4B0082" }}>
                                $
                            </Typography>
                            <Typography component='span' variant='h1' color='primary.main' sx={{ color: "#4B0082" }}>
                                99
                            </Typography>
