...
const AddEventSidebar = (props: AddEventSidebarType) => {
  ...
  const caregiverData = [
    { id: 1, careiverName: 'Alice' },
    { id: 2, careiverName: 'Bob' },
    { id: 3, careiverName: 'Charlie' }
  ]

  console.log('HAHAHAH CG DATA', props)
    ...
    >
      ...
      <Box className='sidebar-body p-6'>
        <form onSubmit={handleSubmit(onSubmit)} autoComplete='off'>
          ...
          >
            {Array.isArray(props?.caregiverList) && props.caregiverList.length > 0 ? (
